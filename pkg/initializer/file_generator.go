...
func generateFileContents(tmpl string, name string, opts InitOptions) (string, error) {
	tokens := generateFileTokens(opts)
	return ApplyTemplate(tmpl, name, tokens)
}

func generateFileTokens(opts InitOptions) fileTokens {
	tokens := fileTokens{}
